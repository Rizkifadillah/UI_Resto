...
import 'package:resto/utils/adapt.dart';
...
Widget buildView(
  ...
  Widget _buildLeftPanel() {
    return SlideTransition(
        position: Tween(begin: Offset.zero, end: Offset(0, 1))
            .animate(state.pageAnimationController),
        child: FadeTransition(
            opacity: Tween(begin: 1.0, end: 0.0).animate(p),
            child: Container(
              width: Adapt.px(350),
              child: Column(
                children: <Widget>[
  ...
  Widget _buildRightPanel() {
    return Column(
      ...
      children: <Widget>[
        SlideTransition(
            position: Tween(begin: Offset.zero, end: Offset(1, 0)).animate(p),
            child: Container(
...
//      height:Adapt.screenH() - Adapt.px(-150),
